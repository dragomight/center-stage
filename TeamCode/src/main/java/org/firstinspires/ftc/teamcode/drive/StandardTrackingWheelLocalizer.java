...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "FrontLeft")); // left encoder
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "FrontRight")); // right encoder
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "BackRight")); // center/back encoder
