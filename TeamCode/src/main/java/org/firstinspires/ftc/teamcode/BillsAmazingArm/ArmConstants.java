...
public class ArmConstants {
    public final static double L0z = 8.0+1.0/16.0;
    public final static double L0x = 1.0+7.0/16.0; // joint 0 is imaginary and immovable, located on the floor at robot center
    ...
    public final static double L2 = 10.25; // in   the distance from joint 2 to joint 3
    public final static double L3 = 8.5; // 7.0+5.0/8.0; // in   the distance from joint 3 to the pulley center
    ...
    public final static double TH3MIN = Math.toRadians(-90.0); // the servo motor or wrist joint
    ...
    public final static double AMAX = 10; // IN/SEC2  well its just a limit
}
