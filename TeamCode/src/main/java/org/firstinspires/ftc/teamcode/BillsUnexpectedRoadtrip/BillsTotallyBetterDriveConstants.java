...
/**
 * This class is based on RR's DriveConstants but with some fat trimmed off.
 * Plus with values for our robot added in.
 */
public class BillsTotallyBetterDriveConstants {
    /*
     * Drive motor qualities
     */
    ...
    public static double INCHES_PER_TICK = WHEEL_RADIUS * 2 * Math.PI * GEAR_RATIO / TICKS_PER_REV;
    public static double VELOCITY_PER_RPM = GEAR_RATIO * 2 * Math.PI * WHEEL_RADIUS / 60.0;
